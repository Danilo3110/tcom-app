        ...
        return (
            <div className={classes.Main}>
                ...
                <div className={classes.AppsContainer}>
                    ...
                    {
                        this.props.user_type === 'admin' || 'user1' ? <div onClick={() => this.clickHandler('user1')} className={classes.AppLinks}><div className={classes.icon}><FontAwesomeIcon icon="comments" size='3x' /></div>Application 1</div> : null
                    }
                    {
